            ...
            <div className="flex flex-col items-center">
              ...
              {isCompleted ? (
                <button
                  ...
                  className="w-5 h-5 sm:w-6 sm:h-6 rounded-full flex items-center justify-center text-white font-bold transition-colors hover:opacity-80 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-green-500 outline-none"
                  style={{
